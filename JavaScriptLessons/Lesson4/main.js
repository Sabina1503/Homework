...
// ------------------------------------------------------------------------------------
// try {
//     documentjnlkd.write("This progress is True");
...
//             var res= metn.startsWith("JavaScript");
//             document.write(res);
...
//       metn.match(/Javascript/gi); hər iki xüsusiyyət işləyər
    //    var metn = "JavaScript superdir";
    //   document.write(metn.match("JavaScript")) ;
...
//       i - böyük və kiçik hərf həssaslığını aradan qaldırar -> metn.repeat(/Javascript/i, "php");
        // var metn = "JavaScript superdir JavaScript";
...
//                         var metn = String.fromCharCode(4);
//                         document.write(metn);
